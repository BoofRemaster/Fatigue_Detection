...
train_data_dir = "./Fatigue_Detection/eye_dataset/train_set"
validation_data_dir = "./Fatigue_Detection/eye_dataset/test_set"
...
def generate_model():
    ...
    model.compile(optimizer=adam_v2.Adam(0.001), loss='binary_crossentropy', metrics=[metrics.BinaryAccuracy(), metrics.Recall(), metrics.AUC(), metrics.TruePositives(),
